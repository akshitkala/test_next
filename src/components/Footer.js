      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          ...
          <div className="flex gap-6 text-muted-foreground">
            <a href="#" className="hover:text-foreground transition-colors">{content.footer.twitter_link_text}</a>
            <a href="#" className="hover:text-foreground transition-colors">{content.footer.github_link_text}</a>
            <a href="#" className="hover:text-foreground transition-colors">{content.footer.discord_link_text}</a>
          </div>
        </div>
      </div>
    </footer>;
