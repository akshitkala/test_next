      ...
      <main className="relative pt-32 pb-20 md:pt-48 md:pb-32">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-20 text-center">
            <h1 className="text-5xl font-extrabold tracking-tight md:text-7xl lg:text-8xl mb-8">About<span className="text-gradient">LPU</span>
            </h1>
            <p className="mx-auto max-w-3xl text-lg text-muted-foreground md:text-xl">Lovely Professional University is a world-class institution dedicated to excellence in teaching, learning, and research. Founded with the vision of creating global leaders, LPU is today a symbol of innovation and academic brilliance.</p>
          </div>
