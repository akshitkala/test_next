        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
              ...
              Built for speed, reliability, and infinite scale.
            </p>
          </div>
          ...
          <div className="mt-32 rounded-[2.5rem] bg-gradient-to-b from-white/[0.05] to-transparent p-12 text-center border border-white/5">
            ...
            <p className="mb-10 text-muted-foreground">Join lakhs of developers building the next generation of web applications.</p>
