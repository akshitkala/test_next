      ...
      <main className="relative pt-32 pb-20 md:pt-48 md:pb-32">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-16 text-center">
            <h2 className="mb-4 text-sm font-bold uppercase tracking-widest text-accent">{content.features.features_heading_badge}</h2>
            ...
            <p className="mx-auto max-w-2xl text-lg text-muted-foreground">{content.features.features_main_description}</p>
          </div>
          ...
          <div className="mt-32">
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              ...
              <div className="lg:col-span-2 group relative rounded-3xl overflow-hidden border border-white/10 aspect-video">
                ...
                <span className="absolute bottom-5 left-5 text-white font-bold text-lg">{content.features.platform_overview_caption}</span>
              </div>
              ...
              <div className="group relative rounded-3xl overflow-hidden border border-white/10 aspect-video lg:aspect-auto">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent" />
                <span className="absolute bottom-5 left-5 text-white font-bold text-lg">{content.features.real_time_data_caption}</span>
              </div>
            </div>
          </div>
