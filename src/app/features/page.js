      ...
      <main className="relative pt-32 pb-20 md:pt-48 md:pb-32">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-16 text-center">
            <h2 className="mb-4 text-sm font-bold uppercase tracking-widest text-accent">{content.navbar.features_link}</h2>
            ...
            <p className="mx-auto max-w-2xl text-lg text-muted-foreground">{content.features.hero_description}</p>
          </div>
          ...
          <div className="relative mb-16 rounded-[2.5rem] overflow-hidden border border-white/10 h-72">
            ...
            <div className="absolute inset-0 flex flex-col justify-center px-12">
              ...
              <h2 className="text-3xl font-extrabold text-white max-w-lg">{content.features.infrastructure_title}</h2>
            </div>
          </div>
          ...
          <div className="mt-32">
            <h2 className="mb-12 text-3xl font-bold text-center">{content.features.screenshot_title}</h2>
            <div className="grid gap-6 lg:grid-cols-3">
              ...
              <div className="lg:col-span-2 group relative rounded-3xl overflow-hidden border border-white/10 aspect-video">
                ...
                <span className="absolute bottom-5 left-5 text-white font-bold text-lg">{content.features.platform_overview}</span>
              </div>
              ...
              <div className="group relative rounded-3xl overflow-hidden border border-white/10 aspect-video lg:aspect-auto">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent" />
                <span className="absolute bottom-5 left-5 text-white font-bold text-lg">{content.features.real_time_data}</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-32 rounded-[2.5rem] bg-gradient-to-b from-white/[0.05] to-transparent p-12 text-center border border-white/5">
            <h2 className="mb-6 text-3xl font-bold md:text-4xl">{content.features.cta_title}</h2>
            <p className="mb-10 text-muted-foreground">{content.features.cta_description}</p>
            <button className="rounded-full bg-foreground px-8 py-4 font-bold text-background transition-transform hover:scale-105 active:scale-95">{content.features.cta_button}</button>
          </div>
        </div>
      </main>
