        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex flex-col items-center text-center">
            <div className="mb-8 inline-flex animate-float items-center rounded-full border border-white/10 bg-white/5 px-3 py-1 text-sm font-medium text-accent">
              <span className="mr-2 rounded-full bg-accent/20 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider">New</span>{content.home.nexus_v2_0_is_now_live}</div>
            ...
            <p className="mb-12 max-w-2xl text-lg text-muted-foreground md:text-xl">{content.home.experience_the_future_of_innovation_with_nexus}</p>
            ...
            <div className="relative mt-20 w-full max-w-5xl">
              ...
              <div className="rounded-3xl border border-white/10 overflow-hidden shadow-[0_40px_120px_rgba(139,92,246,0.2)]">
                <Image src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&q=80" alt={content.home.nexus_analytics_dashboard_with_real_time_data_visualization} width={1200} height={675} className="w-full object-cover" priority />
              </div>
            </div>
            ...
            <div className="mt-32 w-full">
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                ...
                <div className="group relative rounded-3xl overflow-hidden border border-white/10 aspect-video">
                  <Image src="/CateringHome.jpg" alt={content.home.modern_team_workspace_powered_by_nexus} fill className="object-cover transition-transform duration-500 group-hover:scale-105" />
                ...
                <div className="group relative rounded-3xl overflow-hidden border border-white/10 aspect-video">
                  <Image src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=800&q=80" alt={content.home.developers_collaborating_and_building_with_the_nexus_platform} fill className="object-cover transition-transform duration-500 group-hover:scale-105" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent" />
                  <div className="absolute bottom-6 left-6 text-left">
