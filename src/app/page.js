        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex flex-col items-center text-center">
            <div className="mb-8 inline-flex animate-float items-center rounded-full border border-white/10 bg-white/5 px-3 py-1 text-sm font-medium text-accent">
              <span className="mr-2 rounded-full bg-accent/20 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider">{content.home.new_badge_text}</span>{content.home.nexus_v2_live_message}</div>
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <button className="group relative flex h-14 items-center justify-center gap-2 overflow-hidden rounded-full bg-gradient-primary px-8 font-semibold text-white transition-all hover:shadow-[0_0_40px_rgba(139,92,246,0.3)]">{content.home.start_building_now_button_text}<svg className="h-4 w-4 transition-transform group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                </svg>
              </button>
              <button className="flex h-14 items-center justify-center rounded-full border border-white/10 bg-white/5 px-8 font-semibold transition-colors hover:bg-white/10">{content.home.view_documentation_button_text}</button>
            </div>
            ...
            <div className="mt-32 w-full">
              <h2 className="mb-12 text-3xl font-bold text-center">{content.home.crafted_for_modern_teams_heading}</h2>
              <div className="grid gap-6 sm:grid-cols-2">
                ...
                <div className="group relative rounded-3xl overflow-hidden border border-white/10 aspect-video">
                  ...
                  <div className="absolute bottom-6 left-6 text-left">
                    <span className="text-white font-bold text-xl">{content.home.team_workspace_title}</span>
