            ...
            <div className="mt-32 w-full">
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                ...
                <div className="group relative rounded-3xl overflow-hidden border border-white/10 aspect-video">
                  <Image src="/panelify-images/ChatGPT Image Mar 9, 2026, 10_52_46 PM.png" alt="Modern team workspace powered by Nexus" fill className="object-cover transition-transform duration-500 group-hover:scale-105" />
