        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="mb-8 max-w-4xl text-5xl font-extrabold tracking-tight md:text-7xl lg:text-8xl">
              Elevate your <br />
              <span className="text-gradient">digital presence with panelify.</span>
            </h1>
            
            <p className="mb-12 max-w-2xl text-lg text-muted-foreground md:text-xl">Experience the future of innovation with Nexus. </p>
