  ...
  return <div className="relative min-h-screen overflow-hidden selection:bg-accent/30 selection:text-white">
      ...
      <main className="relative pt-32 pb-20 md:pt-48 md:pb-32">
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-8">
                <div>
                  <div className="text-4xl font-bold">{content.company.company_requests_per_sec_value}</div>
                  <div className="text-sm text-muted-foreground uppercase tracking-widest mt-1">{content.company.company_requests_per_sec_label}</div>
                </div>
                <div>
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              <div className="rounded-3xl bg-white/5 border border-white/10 p-2 aspect-square group overflow-hidden">
                <div className="w-full h-full rounded-[1.25rem] bg-gradient-to-br from-accent/20 to-purple-500/10 flex items-center justify-center transition-transform group-hover:scale-[1.02]">
                  <span className="text-accent font-bold">{content.company.company_our_culture_card_title}</span>
                </div>
              </div>
          ...
          {/* Core Values */}
          <div className="mt-48">
            <h2 className="mb-16 text-3xl font-bold text-center">{content.company.company_guided_by_our_values_heading}</h2>
