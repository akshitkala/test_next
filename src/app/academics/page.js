      ...
      <main className="relative pt-32 pb-20 md:pt-48 md:pb-32">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-20 text-center">
            ...
            <p className="mx-auto max-w-3xl text-lg text-muted-foreground md:text-xl">LPU offers a wide range of industry-vetted programs designed to make you future-ready. Our curriculum is constantly updated with inputs from industry leaders.</p>
          </div>
          ...
          <div className="mt-32 p-12 rounded-[3rem] border border-accent/20 bg-accent/5">
             <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                   ...
                   <p className="text-muted-foreground mb-8">We have partnered with top global brands like Google, Microsoft, SAP, and AWS to provide specialized courses and certifications that give our students an edge in the job market.</p>
                   <button className="text-accent font-bold flex items-center gap-2 hover:gap-4 transition-all">Learn about partnerships<span>→</span>
                   </button>
                </div>
